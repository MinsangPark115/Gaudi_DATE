...
dir_path = '/home/aailab/data1/alsdudrla10/'
data_file = dir_path + 'coco/annotations/captions_train2014.json'
...
df_sample.to_csv(dir_path + 'coco/subset_train.csv')

# copy the images to reference folder
from pathlib import Path
import shutil
subset_path = Path(dir_path + 'coco/subset_train')
subset_path.mkdir(exist_ok=True)
for i, row in df_sample.iterrows():
    path = dir_path + 'coco/train2014/' + row['file_name']
    shutil.copy(path, dir_path + 'coco/subset_train/')
